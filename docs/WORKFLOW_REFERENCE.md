...
```yaml
# JFrog Configuration
JFROG_URL: "https://cartert.jfrog.io"
PROJECT_KEY: "bookverse"
DOCKER_REGISTRY: "cartert.jfrog.io"
...
# Images
IMAGE_NAME: "cartert.jfrog.io/bookverse-recommendations-internal-docker-nonprod-local/recommendations:1.2.3"
WORKER_IMAGE: "cartert.jfrog.io/bookverse-recommendations-internal-docker-nonprod-local/recommendations-worker:1.2.4"
...
# Expected Output:
{
  ...
  "audience": "https://cartert.jfrog.io"
}
```
